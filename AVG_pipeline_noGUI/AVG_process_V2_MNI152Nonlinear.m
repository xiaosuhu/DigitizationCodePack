function [probe, refpts,ptsProj, ptsProj_cortex, brain_vol] = AVG_process_V2_MNI152Nonlinear(option,dirnameSubj,dirnameAtlas, digptsfilename, sdfilename, sdfileext)
...
headvol.T_2digpts = gen_xform_from_pts(rp_subj,rp_atlas); % This is an affine transformation


digpts.T_2mc=headvol.T_2digpts; % Added by Xiaosu Hu
